...
For this project, The IRF3205 was chosen owing to its affordability and compatibility with the required gate drive Voltage (Vgs). Futhermore, we need 6 MOSFET's
